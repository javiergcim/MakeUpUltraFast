...
vec3 color_aberration() {
  ...
  aberrated_color.r = texture2D(colortex0, texcoord - offset).r;
  aberrated_color.g = texture2D(colortex0, texcoord - (offset * 0.5)).g;
  aberrated_color.b = texture2D(colortex0, texcoord).b;
