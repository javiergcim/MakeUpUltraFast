...
#define AMBIENT_MIDDLE_COLOR vec3(0.06205, 0.04998, 0.06205) * 1.1
#define AMBIENT_DAY_COLOR vec3(0.06205, 0.04998, 0.06205) * 1.1
#define AMBIENT_NIGHT_COLOR vec3(0.06205, 0.04998, 0.06205) * 1.1
