...
vec3 noised_blur(vec4 color_depth, sampler2D image, vec2 coords, float force, float dither, float pixel_size_x, float pixel_size_y, float fov_y_inv, float inv_aspect_ratio) {
