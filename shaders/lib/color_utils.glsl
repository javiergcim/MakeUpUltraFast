...
uniform float night_mixer;
  ...
  #define LIGHT_NIGHT_COLOR vec3(0.0317353, 0.0467353, 0.0637353) * NIGHT_BRIGHT
  ...
  #define ZENITH_NIGHT_COLOR vec3(0.0168, 0.0228, 0.03) * NIGHT_BRIGHT

  #define HORIZON_SUNSET_COLOR vec3(1.0, 0.6, 0.394)
  #define HORIZON_DAY_COLOR vec3(0.65, 0.91, 1.3)
  #define HORIZON_NIGHT_COLOR vec3(0.02556, 0.03772, 0.05244) * NIGHT_BRIGHT
  ...
  #define LIGHT_NIGHT_COLOR vec3(0.04693014, 0.0507353 , 0.05993107) * NIGHT_BRIGHT

  #define ZENITH_SUNSET_COLOR vec3(0.09410295, 0.20145588, 0.34905882)
  #define ZENITH_DAY_COLOR vec3(0.182, 0.351, 0.754)
  #define ZENITH_NIGHT_COLOR vec3(0.00841175, 0.01651763, 0.025) * NIGHT_BRIGHT

  #define HORIZON_SUNSET_COLOR vec3(0.81, 0.44165647, 0.25293529)
  #define HORIZON_DAY_COLOR vec3(0.572, 1.014, 1.248)
  #define HORIZON_NIGHT_COLOR vec3(0.01078431, 0.02317647, 0.035) * NIGHT_BRIGHT
  ...
  #define LIGHT_NIGHT_COLOR vec3(0.02597646, 0.05195295, 0.069) * NIGHT_BRIGHT

  #define ZENITH_SUNSET_COLOR vec3(0.18135 , 0.230256, 0.332592)
  #define ZENITH_DAY_COLOR vec3(0.104, 0.26, 0.507)
  #define ZENITH_NIGHT_COLOR vec3(0.004 ,0.01, 0.0195) * NIGHT_BRIGHT

  #define HORIZON_SUNSET_COLOR vec3(1.3, 0.8632, 0.3952)
  #define HORIZON_DAY_COLOR vec3(0.65, 0.91, 1.3)
  #define HORIZON_NIGHT_COLOR vec3(0.025, 0.035, 0.05) * NIGHT_BRIGHT

  #define WATER_COLOR vec3(0.05, 0.1, 0.11)
#elif COLOR_SCHEME == 5  // Psychedelic
  #define OMNI_TINT 0.45
  #define LIGHT_SUNSET_COLOR vec3(0.85 , 0.47058824, 0.17921569)
  #define LIGHT_DAY_COLOR vec3(0.91021875, 0.95771875, 0.472625)
  #define LIGHT_NIGHT_COLOR vec3(0.04223712, 0.04566177, 0.05393796) * NIGHT_BRIGHT

  #define ZENITH_SUNSET_COLOR vec3(0.12215686, 0.22352941, 0.34901961)
  #define ZENITH_DAY_COLOR vec3(0.02745098, 0.22941176, 0.71176471)
  #define ZENITH_NIGHT_COLOR vec3(0.00905881, 0.02078822, 0.039) * NIGHT_BRIGHT

  #define HORIZON_SUNSET_COLOR vec3(1.0, 0.4, 0.194)
  #define HORIZON_DAY_COLOR vec3(0.36019608, 0.60058824, 1.0)
  #define HORIZON_NIGHT_COLOR vec3(0.01392647, 0.0415147, 0.0675) * NIGHT_BRIGHT
  ...
  #define ZENITH_NIGHT_COLOR vec3(0.014, 0.019, 0.031) * NIGHT_BRIGHT

  #define HORIZON_SUNSET_COLOR vec3(1.183, 0.858, 0.611)
  #define HORIZON_DAY_COLOR vec3(0.52, 0.975, 1.3)
  #define HORIZON_NIGHT_COLOR vec3(0.022, 0.029, 0.049) * NIGHT_BRIGHT
