...
#define NIGHT_BRIGHT_PHASE (NIGHT_BRIGHT + (NIGHT_BRIGHT * (abs(4.0 - moonPhase) * 0.25)))
  ...
  #define ZENITH_SUNSET_COLOR vec3(0.0 , 0.0, 1.0)
  #define ZENITH_DAY_COLOR vec3(0.0, 0.0, 1.0)
  #define ZENITH_NIGHT_COLOR vec3(0.0, 0.0, 1.0) * NIGHT_BRIGHT_PHASE

  #define HORIZON_SUNSET_COLOR vec3(1.0, 0.0, 0.0)
  #define HORIZON_DAY_COLOR vec3(1.0, 0.0, 0.0)
  #define HORIZON_NIGHT_COLOR vec3(1.0, 0.0, 0.0) * NIGHT_BRIGHT_PHASE
