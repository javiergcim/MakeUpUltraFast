...
uniform float night_mixer;
  ...
  #define HI_NIGHT_COLOR vec3(0.00841175, 0.01651763, 0.039) * NIGHT_BRIGHT
  ...
  #define AMBIENT_DAY_COLOR vec3(0.958125, 1.008125, 0.4975)
