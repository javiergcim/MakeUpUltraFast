...
#define NIGHT_BRIGHT_PHASE (NIGHT_BRIGHT + (NIGHT_BRIGHT * (abs(4.0 - moonPhase) * 0.25)))
  ...
  // #define ZENITH_NIGHT_COLOR vec3(0.00905881, 0.02078822, 0.039) * NIGHT_BRIGHT_PHASE

  // #define HORIZON_SUNSET_COLOR vec3(1.0, 0.4, 0.194)
  // #define HORIZON_DAY_COLOR vec3(0.36019608, 0.60058824, 1.0)
  // #define HORIZON_NIGHT_COLOR vec3(0.01392647, 0.0415147, 0.0675) * NIGHT_BRIGHT_PHASE
