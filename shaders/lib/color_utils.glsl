...
uniform float night_mixer;
  ...
  // #define HI_MIDDLE_COLOR vec3(0.0745098 , 0.22352941, 0.54901961)
  #define HI_MIDDLE_COLOR vec3(0.14901961, 0.2627451 ,0.3843137)
  // #define HI_DAY_COLOR vec3(0.14901961, 0.2627451 ,0.3843137)
  // #define HI_DAY_COLOR vec3(0.14901961, 0.2627451 ,0.3843137)
  #define HI_DAY_COLOR vec3(0.09019608, 0.26078431, 0.44313725)
  #define HI_NIGHT_COLOR vec3(0.0168, 0.0228, 0.03) * NIGHT_BRIGHT

  // #define LOW_MIDDLE_COLOR vec3(1.183, 0.658, 0.311)
  #define LOW_MIDDLE_COLOR vec3(0.79215686, 0.67843137, 0.67058824) * 1.1
  // #define LOW_DAY_COLOR vec3(0.54705882, 0.63333333, 0.95392157)
  // #define LOW_DAY_COLOR vec3(0.54705882, 0.63333333, 0.85392157)
  #define LOW_DAY_COLOR vec3(0.47254902, 0.60196078, 0.93137255)
  #define LOW_NIGHT_COLOR vec3(0.02556, 0.03672, 0.04644) * NIGHT_BRIGHT
